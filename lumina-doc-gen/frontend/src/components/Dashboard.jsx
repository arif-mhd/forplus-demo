    ...
    return (
        <div className="p-8 lg:p-12 max-w-7xl mx-auto animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <button className="group relative p-6 bg-[#111] border border-white/10 rounded-2xl hover:bg-[#161616] transition-all text-left border-dashed flex flex-col items-center justify-center text-center">
                    <div className="text-gray-600 mb-2">+ Custom Template</div>
