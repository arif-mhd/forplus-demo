                ...
                <div className="space-y-4">
                    <div>
                        <label className="block text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                            <ImageIcon size={14} className="text-zinc-300" /> Logo URL
                        </label>
                        <input
                            type="text"
                        ...
                        />
                        <p className="text-[10px] text-zinc-300 mt-1 uppercase tracking-widest font-black">Direct link to an image file (PNG/JPG).</p>
                    </div>
